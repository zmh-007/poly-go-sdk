...
import (
	...
	common3 "github.com/ontio/multi-chain-go-sdk/common"
...
func (this *MultiChainSdk) MultiSignToTransaction(tx *types.MutableTransaction, m uint16, pubKeys []keypair.PublicKey, signer Signer) error {
	pkSize := len(pubKeys)
...
func (this *MultiChainSdk) GetTxData(tx *types.MutableTransaction) (string, error) {
